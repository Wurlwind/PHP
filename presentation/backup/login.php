...
$db = new PDO(DBConfig::$DB_CONNSTRING, DBConfig::$DB_USERNAME, '');

// already logged in!
if (isset($_SESSION['user'])) { //hier misschien gebruik maken van een bool check? die je aanzet als je inlogt? 'loggedin' bv?
...
if (isset($_POST['moduleAction']) && ($_POST['moduleAction'] == 'login')) {
	...
	$stmt = $db->prepare('SELECT * FROM siteuser WHERE username = ?');
	$stmt->execute(array($username)); //wat doet dit
...
<body>
	...
	<p class="note">Use your username and password to log in.</p>
